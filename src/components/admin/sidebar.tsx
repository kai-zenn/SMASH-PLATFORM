import { LayoutDashboard, QrCode, Users, Tags, FileText, LogOut } from 'lucide-react';
...
export function AdminSidebar({ currentTab, setTab, userNama, onLogout, id }: SidebarProps) {
  const menuItems = [
    ...
    >
      <div className="flex flex-col">
        ...
        <div className="p-4 border-b border-neutral-800 hidden md:block">
          ...
          <div className="inline-flex items-center gap-1 bg-neutral-100/10 text-neutral-300 border border-neutral-100/10 rounded-full px-2.5 py-0.5 text-xxs font-medium mt-2">
            ⚙️ Bank Sampah Pusat
          </div>
        </div>
